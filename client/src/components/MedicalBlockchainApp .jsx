...
const MedicalBlockchainApp = () => {
	...
	const handleSubmit = (e) => {
		...
		alert(
			`Bệnh nhân đã được tạo thành công!\nBlockchain Hash: ${mockHash}`
		);
						...
						<div className="flex items-center space-x-3">
							...
							<div>
								...
								<p className="text-gray-600">
									Tạo hồ sơ y tế trên blockchain
								</p>
							</div>
						</div>
						<button
						...
						<div className="flex items-start space-x-3">
							...
							<div>
								...
								<p className="text-sm opacity-90 mb-2">
									Hồ sơ bệnh nhân sẽ được mã hóa và lưu trữ an
									toàn trên blockchain. Mọi thay đổi đều được
									ghi lại và không thể thay đổi.
								</p>
								<ul className="text-xs opacity-80 space-y-1">
									<li>• Dữ liệu được mã hóa AES-256</li>
									<li>
										• Hash được tạo tự động cho mỗi bản ghi
									</li>
									<li>
										• Chỉ người có quyền mới có thể truy cập
									</li>
								</ul>
							</div>
						</div>
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-gray-600">
						...
						{activeTab === "patients" &&
							"Danh sách và thông tin bệnh nhân"}
		...
		<div className="space-y-6">
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
				{[
					...
					<div
						key={index}
						className={`bg-gradient-to-r from-${stat.color}-500 to-${stat.color}-600 text-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow`}>
						<div className="flex items-center justify-between">
							<div>
